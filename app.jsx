...
const CATEGORIES = [
  ...
  },
  {
    ...
    img: "images/wall_mounted_table.png",
...
function Hero() {
  return (
    <section className="hero" id="top">
      <div className="hero-bg"><img src="images/hero.png" alt="Представительский кабинет ВМ-Торг" /></div>
    ...
    <section className="section about" id="about">
      <div className="wrap about-grid">
        ...
        <div className="about-media reveal d2">
          <div className="frame"><img src="images/wine_cabinet.png" alt="Изделие ручной работы" /></div>
          <div className="badge">
    ...
    <section className="section prod" id="production">
      <div className="wrap prod-grid">
        ...
        <div className="prod-media reveal d2">
          <img src="images/chest.png" alt="Производство мебели" />
