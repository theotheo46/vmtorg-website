...
Исходный промпт:
```
Создай фотореалистичное изображение винного шкафа на основе референса:
...
**Subject:** A photorealistic image of an empty wine cabinet, shown in full frame.

**Perspective & Composition:** * **Angle:** Isometric projection (do not use a flat, straight-on frontal view). 
* **Framing:** The entire cabinet must fit within the frame. 
* **Environment:** The cabinet is completely empty inside. There are no background elements, props, or other objects in the scene—only the cabinet. 
* **Constraints:** Maintain standard realistic proportions and do not hallucinate or add any extra decorative details.

**Materials & Textures:**
* **Wood:** The top surface and the bottom row of solid doors are made of **American walnut** using a **'mix match' veneer layout**.
* **Realism:** The wood texture must be highly realistic, displaying natural porosity, subtle grain variations, and artifacts typical of naturally treated natural wood.
* **Texture Variation (Crucial):** Do not repeat or clone the exact same wood texture across the front panels. Each door and panel should have a slightly different texture pattern (e.g., slightly shifted or rotated natural grain).
* **Glass:** The top two rows consist of transparent glass doors.
* **Handles:** All handles are **antique gold**.

**Specific Structural Details:**
* **Top Surface:** The top wooden surface must have three faintly visible seams, dividing it into four distinct sections. Each of these four sections must have its own unique variation of the wood texture.
* **Metal Framing:** The black metal frame around the glass is not a single seamless piece. It is made of four distinct sections connected by visible seams/joints. The color of the metal frame is **black**.
